export default {
  ...
  roleEdit: {
    ...
    namePrompt: 'Name for the new role:',
    model: 'Bound model',
    thinking: 'Enable extended thinking (MAX_THINKING_TOKENS=16000)',
    systemPrompt: 'System prompt (inline content — lives in roles.yaml)',
    systemPromptPh: '# You are the …\nDescribe what this role does and how.',
